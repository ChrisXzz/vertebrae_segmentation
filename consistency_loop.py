...
def load_vertebrae_sizes_pkl(pkl_file='statistics/vertebrae_sizes.pkl'):
    import pickle 
...
def filtered_connected_components(diff, 
    ...
    for l in range(1, ncomponents+1):
        ...
        from regressor import regressor_size_one_side
...
def _is_gap_fitting_regressor(gap_list, idx, group_label):
    from regressor import regressor_gap_one_side, regressor_gap_two_sides
